...
if st.button('Developed by:'):
            st.subheader('Group : 6 (Team Members)')
            st.write('Praveen Kumar')
            st.write('Shruti Gupta')
            st.write('Shweta Barnwal')
            st.write('Abhinav Kumbalwar')
            st.write('Nilesh Bajgude')
            st.write('Keshav Chaudhary')
            st.write('Dhanush Kumar K')
